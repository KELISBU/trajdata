...
class WaymoDataset(RawDataset):
    ...
    def get_agent_info(
        ...
        try:
            ...
            print(f"Warnings:scene{scene.raw_data_idx} noagents to remove{agents_to_remove}")
    ...
    def cache_map(
        ...
        try:
            # Your existing code to cache maps
            map_cache_class.finalize_and_cache_map(cache_path, vector_map, map_params)
        except Exception as e:
            print(f"Error caching maps for {self.name}_{data_idx}: {e}")
