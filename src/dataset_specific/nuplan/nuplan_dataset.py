...
class NuplanDataset(RawDataset):
    ...
    def get_agent_info(
        ...
        ego_df[['vx', 'vy', 'ax', 'ay']] = transform_v_a_to_world( ego_df["heading"], ego_df[['vx', 'vy', 'ax', 'ay']].values)
...
def transform_v_a_to_world(heading, ego_data) -> pd.DataFrame:
    ...
    # Assuming ego_data contains  ego_data['vx', 'vy', 'ax', 'ay']
